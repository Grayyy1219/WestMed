...
<body>
    ...
    {
        $sql = "UPDATE category SET ItemCategory =? WHERE CategoryID =?";
        $stmt = $con->prepare($sql);
        ...
        <section>
            <div class="wrapper" id="w3">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    <input type="hidden" name="GenreID" value="<?php echo htmlspecialchars($GenreDetails['CategoryID']); ?>">
                    Title: <input type="text" name="title" value="<?php echo htmlspecialchars($GenreDetails['ItemCategory']); ?>"><br>
