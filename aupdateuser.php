...
if (isset($_POST["submit"])) {
    ...
    $queryUpdate = mysqli_query($con, "UPDATE currentuser SET profile = '$location', FName = '$first_name', Email = '$email', address ='$address', phone = '$phone' WHERE userid = $targetUserId");
