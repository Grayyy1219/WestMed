...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2024 at 12:38 PM
...
(1, 'WestMed', '', 'admin', 'westmed.shopnoreply@gmail.com', '', '', 'upload/users/logo.png');
...
(34, 'Efficascent Relaxing 6ml Oil', ' It helps relieve headache travel and motion sickness stomach and abdominal pain dizziness stiff neck, stuffy nose, itchiness, and insect bites.', 'Home Remedies', 'upload/items/efficascent-relaxing-6ml-oil.jpg', 79.00, 3, 57),
(35, 'Efficascent Oil Extreme 25ml', 'Specially formulated for fast and effective relief of rheumatism joint pains lumbago cramps and other common body and muscular pains.', 'Home Remedies', 'upload/items/efficascent-oil-extreme-25ml.jpg', 39.00, 3, 22),
...
(48, 'Emma  Reyes', '', 'Emz', '$2y$10$EK7M2dFaWlDEjqK1wCv3E.ZRuKHh4hK3MFa//VaksgBx/dJzmDKpW', 'mmaerys01@gmail.com', '', '', 0, 0, 'upload/users/ttn-image-2023-09-30-191330979.png', '1', '87604'),
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=435430;
