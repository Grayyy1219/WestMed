...
<body>
    ...
    {
        $sql = "INSERT INTO paymethod (method_name ) VALUES (?);";
        ...
        try {
            ...
            echo "<script>window.location.href = 'addpayment.php';</script>";
    ...
    <section>
        <div class="wrapper" id="w3">
            <h2 style="font-size: 30px;">Ad Payment Method</h2><br>
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                Method: <input type="text" name="genre" value="" required><br>
